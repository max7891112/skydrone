...
},{"../../shared/utils.js":"m25W"}],"viHq":[function(require,module,exports) {
"use strict";
...
},{"../../shared/utils.js":"m25W"}],"hlp9":[function(require,module,exports) {
"use strict";
...
},{}],"d6Yd":[function(require,module,exports) {
"use strict";
...
},{"../../shared/utils.js":"m25W"}],"H67I":[function(require,module,exports) {
"use strict";
...
},{"../../shared/utils.js":"m25W"}],"qOVu":[function(require,module,exports) {
"use strict";
...
},{}],"MAjK":[function(require,module,exports) {
"use strict";
...
},{"ssr-window":"RQSI","../../shared/utils.js":"m25W"}],"eH86":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
_swiper.default.use([_swiper.Navigation, _swiper.Pagination, _swiper.Autoplay, _swiper.EffectFade]);
var mySwiper = /*#__PURE__*/function () {
  ...
  _createClass(mySwiper, [{
    ...
    value: function addPagination() {
      var swiper = new _swiper.default('.image-slider', {
      ...
      var links = document.querySelectorAll('.navigation-menu__link');
...
exports.default = _default;
},{"swiper":"MGWF"}],"byNO":[function(require,module,exports) {
"use strict";
...
var Header = /*#__PURE__*/function () {
  ...
  _createClass(Header, [{
          ...
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            menuLink.addEventListener('click', function (event) {
              ...
              if (target.dataset.goto && document.querySelector(target.dataset.goto)) {
                ...
                event.preventDefault();
                if (_this.menuBurger.nextElementSibling.classList.contains('header__nav_clicked')) {
                  _this.listenerMenuBurger();
                }
              }
            });
          }
    ...
    key: "addMenuBurger",
    value: function addMenuBurger() {
      var _this2 = this;
      this.menuBurger.addEventListener('click', this.listenerMenuBurger = function () {
        document.body.classList.toggle('_lock');
        _this2.menuBurger.classList.toggle('header__icon_clicked');
        _this2.menuBurger.previousElementSibling.classList.toggle('logo_clicked');
        _this2.menuBurger.nextElementSibling.classList.toggle('header__nav_clicked');
        _this2.menuBurger.parentNode.classList.toggle('header_clicked');
      });
    }
  }]);
  return Header;
...
var _swipper = _interopRequireDefault(require("./components/swiper/swipper.js"));
var _header = _interopRequireDefault(require("./components/header/header.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
_header.default.addMenuBurger();
_header.default.smoothNavigation();
_swipper.default.addPagination();
},{"./components/swiper/swipper.js":"L26K","./components/header/header.js":"byNO"}]},{},["Focm"], null)